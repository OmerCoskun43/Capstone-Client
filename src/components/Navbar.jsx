...
export function NavbarDefault() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        ...
        variant="small"
        color="blue-gray"
        className="flex items-center gap-x-2  font-bold bg-white rounded-lg px-2 py-1"
      >
        <svg
          width="14"
          height="15"
  ...
  return (
    <Navbar className="mx-auto bg-purple-400 max-w-screen-2xl px-4 py-2 lg:px-8 lg:py-3">
      <div className="container mx-auto flex items-center justify-between text-black ">
        <Link
          to="/"
          className="mr-4 cursor-pointer border-[1px] border-black text-green-700  font-bold bg-white px-3 py-2 rounded-lg anime"
        >
          <span className="animate-pulse">Capstone Blog </span>
        </Link>
        ...
        {!user ? (
          <div className="flex items-center gap-x-1">
            <Button
              ...
              variant="outlined"
              size="sm"
              className="hidden lg:inline-block bg-white"
            >
              <span>Log In</span>
            </Button>
            <Button
